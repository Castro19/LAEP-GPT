...
const DoubleSliderFilter = forwardRef<
  HTMLDivElement,
  InstructorRatingRangeFilterProps
>(
  (
    {
      initialRange = [0, 4],
    ...
    return (
      <div
        ref={ref}
        className="flex flex-col items-center space-y-2 w-full mt-2"
      >
...
DoubleSliderFilter.displayName = "DoubleSliderFilter";
