...
router.post("/signup", async (req, res) => {
  try {
    ...
    console.log("Received in /signup: ", { firebaseUserId, firstName, lastName, about }, userType); // Debugging line
    console.log("Received userType: ", userType);
    if (!firebaseUserId) {
      return res.status(400).send("Firebase User ID is required");
    }
    console.log("user.js Passing to addUser: ", { firebaseUserId, firstName, lastName, about }, userType); // Debugging line
